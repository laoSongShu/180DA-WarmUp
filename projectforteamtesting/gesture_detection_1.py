...
while True:
    ...
    if 0:
        outputString += "#  rate_gyr_x %5.2f rate_gyr_y %5.2f rate_gyr_z %5.2f #  " % (rate_gyr_x, rate_gyr_y, rate_gyr_z)
    ...
    if 0:
        outputString += "#  accXnorm %5.2f accYnorm %5.2f accZnorm %5.2f #  " % (accXnorm, accYnorm, accZnorm)
    ...
    if 0:                       #Change to '0' to stop showing the angles from the accelerometer
        ...
        if ((AccXangle > 45) and (AccYangle < 45)) and (AccYangle > -45):
            outputString += "Direction 1"
        elif ((AccXangle < -45) and (AccYangle < 45)) and (AccYangle > -45):
            outputString += "Direction 2"
        elif ((AccYangle > 45) and (AccXangle < 45)) and (AccXangle > -45):
            outputString += "Direction 3"
        elif ((AccYangle < -45) and (AccXangle < 45)) and (AccXangle > -45):
            outputString += "Direction 4" 
        else:
            outputString += "I can't recognize the motion, but I can bite you, I mean it"
